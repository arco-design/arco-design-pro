...
const simplePath = path.resolve(__dirname, "../simple-pro-template/arco-design-pro-cra");
const templatePath = path.resolve(__dirname, "../arco-design-pro-cra");
const projectPath = params.projectPath || path.resolve(__dirname, "../examples/arco-design-pro-cra" + `${isSimple ? '-simple' : ''}`);
