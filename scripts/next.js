...
const simplePath = path.resolve(__dirname, '../simple-pro-template/arco-design-pro-next');
const templatePath =  path.resolve(__dirname, "../arco-design-pro-next");
const projectPath =  params.projectPath || path.resolve(__dirname, "../examples/arco-design-pro-next" + `${isSimple ? '-simple' : ''}`);
