  ...
  return (
    <div className={styles.container}>
      <Breadcrumb style={{ marginBottom: 20 }}>
        ...
        <Breadcrumb.Item>{t['menu.list.cardList']}</Breadcrumb.Item>
      </Breadcrumb>
            ...
            <Grid.Row justify="space-between">
              <Grid.Col span={14}>
                <Tabs defaultActiveTab="1" type="rounded">
                  ...
                  <Tabs.TabPane key="3" title={t['cardList.tab.title.develop']} />
                  <Tabs.TabPane key="4" title={t['cardList.tab.title.network']} />
        ...
        <Grid.Col span={6}>
          <div className={styles['right-content']}>
            ...
            <Card bordered={false} className={styles['right-content__item']}>
              ...
              <Result status="404" subTitle={t['cardList.announcement.noData']} />
            </Card>
          </div>
        </Grid.Col>
      </Grid.Row>
