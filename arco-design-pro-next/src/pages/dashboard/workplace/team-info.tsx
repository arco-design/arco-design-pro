...
const renderListItem = (item, index) => (
  <List.Item
    key={index}
    actions={[
      <Button key="1" size="mini" type="text" icon={<IconEdit />} />,
      <Button key="2" size="mini" type="text" icon={<IconDelete />} />,
    ]}
  >
    <List.Item.Meta
      avatar={
