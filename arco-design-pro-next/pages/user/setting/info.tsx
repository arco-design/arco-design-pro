...
export default function Info() {
  ...
  return (
    <Form className={styles['info-form']} layout="vertical" ref={formRef}>
      ...
      <Form.Item label={t['userSetting.label.name']} field="name" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item
      ...
      <Form.Item label={t['userSetting.label.introduction']} field="introduction">
        <Input.TextArea />
      </Form.Item>

      <Typography.Title heading={6}>{t['userSetting.title.socialInfo']}</Typography.Title>
      <Form.Item label={t['userSetting.label.personalWebsite']} field="personalWebsite">
        <Input />
      </Form.Item>
      <Form.Item label={t['userSetting.label.personalWebsite']} field="personalWebsite">
        <Input />
